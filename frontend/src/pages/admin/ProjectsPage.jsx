            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-display font-bold line-clamp-1" style={{ color: 'var(--text-primary)' }}>
                      {project.name}
                    </h3>
                    <p className="text-sm" style={{ color: 'var(--text-muted)' }}>{project.client_name}</p>
                  </div>
                </div>
                ...
                <div className="relative group/menu">
                  ...
                  <div 
                    className="absolute right-0 top-full mt-1 w-40 py-1 rounded-lg shadow-lg opacity-0 invisible group-hover/menu:opacity-100 group-hover/menu:visible transition-all z-10"
                    style={{ 
              ...
              {/* Stats */}
              <div className="flex items-center gap-4 py-4" style={{ borderTop: '1px solid var(--border-primary)' }}>
                <div className="flex items-center gap-2 text-sm">
                  <MessageSquare className="w-4 h-4" style={{ color: 'var(--accent-purple)' }} />
